...
<html>
<head>
<title>RadheKant | Register</title>
											...
											<div class="login-right">
												<form action = "register-exec.php" method = "post">
													...
													<?php if (isset($err_message)) {
														echo '<p style = "color : #FF0000">' . $err_message . '</p>';
													}?>
													...
													<input type="password" name = "cpassword" value="Confirm Password" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Confirm Password';}" required="">	
