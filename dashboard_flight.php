...
if (isset($_GET["update"])) {
	...
	updateTableWithId("flight_data", $id, ["time", "time_arr", "number_of_passenger", "price"], [$dep, $arr, $number_of_passenger, $price]);

}
$result = searchAll("flight_data");
?>
				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					<nav class="cl-effect-1">
						<ul class="nav navbar-nav">
								...
								<li class="active"><a href="dashboard_flight.php">Flight Data Dashboard</a></li>
								<li ><a href="dashboard_passenger.php">Passenger Data Dashboard</a></li>
...
<div class="bus-midd wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">
	...
	<!--- ul-first  ---->
		...
		echo '<form action = "dashboard_flight.php" method = "get">';
		...
		echo '  <li class="dept" style = "width : 13%">
				<div class="bus-txt3">
					<input style = "border:none;" name = "number_of_passenger" type = "text" value = "' . $search_result["number_of_passenger"]  . '">
				</div>
				<div class="clearfix"></div>
				</li>';
		...
		echo '	<li class="dept" style = "width : 13%">
				<div class="bus-txt4">
					<h5> ₹ <div style=" margin-top: -23px; margin-left: 15px;"><input style = "border:none;" name = "price" type = "text" value = "' . $search_result["price"] . '"></div></h4>
