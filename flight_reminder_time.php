...
if (isset($_GET["update"])) {
	...
	$reminder_days = $_GET["reminder_days"];
	updateTableWithCondition("flight_reminder_time", ["key" => "flight_name", "value" => $flight_name], ["reminder_days"], [$reminder_days]);

}
$result = searchAllWithoutCondition("flight_reminder_time");
?>
				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					<nav class="cl-effect-1">
						<ul class="nav navbar-nav">
								...
								<li class="active"><a href="flight_reminder_time.php">Flight (T-X)</a></li>
...
<div class="bus-btm">
	<div class="container">
		<ul>
			<li class="trav" style = "width : 40%"><a href="#">Flight Name</a></li>
			<li class="dept" style = ><a href="#">Reminder Days (T-X)</a></li>
				<div class="clearfix"></div>
		</ul>
	</div>
</div>
...
<div class="bus-midd wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">
	...
	<!--- ul-first  ---->
		...
		echo '<form action = "flight_reminder_time.php" method = "get">';
		echo '<div style = "padding-top : 20px">';
		echo '	<li class="trav" style = "width : 40% ; padding-top : 10px">
					<h4>' . $search_result["flight_name"] . '</h4>
				<div class="clearfix"></div>
				</li>';

		echo '  <li class="dept">
					<div ><input style = "border:none;" name = "reminder_days" type = "text" value = "' . $search_result["reminder_days"] . '">Days</div>
				<div class="clearfix"></div>
				</li>';
	
		echo '     <input name = "flight_name" type = "hidden" value = "' . $search_result["flight_name"] . '">
