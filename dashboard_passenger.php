				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					<nav class="cl-effect-1">
						<ul class="nav navbar-nav">
								...
								<li ><a href="dashboard_flight.php">Flight Data Dashboard</a></li>
								<li class="active"><a href="dashboard_passenger.php">Passenger Data Dashboard</a></li>
								<li><a href="flight_reminder_time.php">Flight (T-X)</a></li>
								<li ><a href="dashboard_reminder.php">Flight Timing Reminder</a></li>
								<div class="clearfix"></div>
						</ul>
...
<div class="bus-btm">
	<div class="container">
		<ul>
		<?php
			echo '	<li class="trav" style = "width : ' . $column1. '%"><a href="#">Passenger Name</a></li>
					<li class="dept" style = "width : ' . $column2. '%"><a href="#">PNR</a></li>
					<li class="dept" style = "width : ' . $column2. '%"><a href="#">Date-Time</a></li>
					<li class="dept" style = "width : ' . $column2. '%"><a href="#">Origin</a></li>
					<li class="dept" style = "width : ' . $column2. '%"><a href="#">Destination</a></li>
					<li class="dept" style = "width : ' . $column2. '%"><a href="#">Price</a></li>
					<li class="dept" style = "width : ' . $column2. '%"><a href="#">Booked By</a></li>';
...
<div class="bus-midd wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">
	...
	<!--- ul-first  ---->
		...
		echo '  <li class="dept" style = "width : 14%">
					<h4>' . $search_result["PNR"] . '</h4>
				<div class="clearfix"></div>
				</li>';


		echo '	<li class="dept" style = "width : ' . $column2. '%">
					<h4><a href="#">'. date("jS M, Y", strtotime($search_result["date"])) . '</a></h4>
					
					<p> Dep : <div style=" margin-top: -21px; margin-left: 37px;"><input style = "border:none;" name = "DEP" type = "text" value = "' . $search_result["time"] . '"></div></p>
					<p> Arr : <div style=" margin-top: -21px; margin-left: 37px;"><input style = "border:none;" name = "ARR" type = "text" value = "' . $search_result["time_arr"] . '"></div></p>
				<div class="clearfix"></div>
				</li>';
		...
		echo '	<li class="dept" style = "width : ' . $column2. '%">
				<div class="bus-txt4">
					<h5> ₹ ' . $search_result["price"] . '</h3>

					';

		echo '	<li class="dept" style = "width : ' . $column2. '%">
				<div class="bus-txt2">
					<p style = "font-size : 15px"> ' . $search_result["booked_by"] . '</p>
					';
	
		echo '     <input name = "selected_id" type = "hidden" value = "' . $search_result["id"] . '">
