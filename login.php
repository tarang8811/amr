								...
								<div class="login">
									...
									<div class="login-right">
										<form action = "login-exec.php" method = "post">
											...
											<input type="text" name = "login" value="Enter your mobile number or Email" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Enter Email';}" required="">	
